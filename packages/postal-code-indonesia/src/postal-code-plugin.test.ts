...
describe('PostalCodePlugin', () => {
  ...
  it('should enrich villages with postal codes', async () => {
    const villages = [
      { code: '11.06.03.2027', name: 'Desa Test', districtCode: '11.06.03', type: 'DESA' },
      { code: '11.06.03.2028', name: 'Desa Test 2', districtCode: '11.06.03', type: 'DESA' }
    ];
  ...
  it('should return empty string for unknown village codes', async () => {
    const villages = [
      { code: '99.99.99.9999', name: 'Unknown Village', districtCode: '99.99.99', type: 'DESA' }
    ];
